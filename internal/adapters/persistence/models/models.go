...
type PDPASetting struct {
	...
	ArticleTitle    string    `gorm:"type:text" json:"article_title"`
	ArticleContent  string    `gorm:"type:text" json:"article_content"`
	UpdatedAt       time.Time `gorm:"autoUpdateTime" json:"updated_at"`
}

// DefaultPDPAArticleTitle / DefaultPDPAArticleContent seed the singleton row
// on first creation, so the cooperative's already-approved PDPA notice isn't
// blank before an Officer/Admin edits it. Admin can change this anytime via
// PUT /admin/committee/pdpa-settings without needing a code change.
const (
	DefaultPDPAArticleTitle = "ข้อควรรู้: การคุ้มครองข้อมูลด้านสินเชื่อภายในสหกรณ์ (PDPA)"

	DefaultPDPAArticleContent = `ในยุคดิจิทัล "ข้อมูลส่วนบุคคล" ถือเป็นสิ่งมีค่าและต้องได้รับการคุ้มครอง พระราชบัญญัติคุ้มครองข้อมูลส่วนบุคคล พ.ศ. 2562 (PDPA) จึงเข้ามามีบทบาทสำคัญในการสร้างมาตรฐานใหม่ เพื่อให้สมาชิกสหกรณ์ทุกคนมั่นใจได้ว่า ข้อมูลของท่านจะถูกนำไปใช้ประโยชน์อย่างโปร่งใสและปลอดภัย

เพื่อให้เป็นไปตามกฎหมายดังกล่าว สหกรณ์จึงได้วาง "ระเบียบสหกรณ์ว่าด้วยการใช้ข้อมูลส่วนบุคคล" สำหรับการดำเนินงานภายในไว้ดังนี้:

1. ระเบียบการจัดเก็บข้อมูลที่จำเป็น
สหกรณ์จะจัดเก็บและใช้ข้อมูลของสมาชิกเฉพาะที่จำเป็นต่อการดำเนินงานเท่านั้น ได้แก่:
- ชื่อ - นามสกุล: เพื่อยืนยันตัวตนความเป็นสมาชิก
- ข้อมูลสินเชื่อ: วงเงินกู้ ประวัติการชำระหนี้ และข้อมูลเกี่ยวกับด้านธุรกรรมสินเชื่อเท่านั้น

2. ระเบียบการใช้งานและวัตถุประสงค์ภายใน
สหกรณ์กำหนดให้มีการประมวลผลข้อมูลดังกล่าวเฉพาะงานด้านสินเชื่อภายในสหกรณ์เท่านั้น โดยอาศัยอำนาจตามระเบียบสหกรณ์ในการ:
- ใช้พิจารณาอนุมัติ จัดทำสัญญากู้ยืม และบริหารจัดการหนี้สินตามที่สมาชิกยื่นความประสงค์
- ใช้ประกาศหรือแจ้งเตือนภายในกลุ่มสมาชิกเท่าที่จำเป็น โดยไม่มีการเปิดเผยข้อมูลนี้แก่บุคคลภายนอก เว้นแต่เป็นการปฏิบัติตามกฎหมายที่เกี่ยวข้องกับสหกรณ์

3. ระเบียบการจำกัดสิทธิ์และการรักษาความปลอดภัย
- จำกัดผู้เข้าถึง: ระเบียบสหกรณ์กำหนดให้ข้อมูลธุรกรรมสินเชื่อเข้าถึงได้เฉพาะ คณะกรรมการสหกรณ์ ที่มีอำนาจอนุมัติ และ เจ้าหน้าที่สินเชื่อ ที่รับผิดชอบโดยตรงเท่านั้น
- ระบบความปลอดภัย: จัดเก็บในระบบคอมพิวเตอร์ที่มีการล็อกรหัสผ่านอย่างเข้มงวด ป้องกันการเข้าถึงโดยไม่ได้รับอนุญาต

สรุป: การใช้ข้อมูล ชื่อ-นามสกุล และประวัติสินเชื่อทั้งหมด เป็นไปเพื่อการบริหารจัดการและบริการด้านสินเชื่อภายในสหกรณ์เท่านั้น ไม่เกี่ยวข้องกับระบบอื่น สมาชิกจึงมั่นใจได้ว่าข้อมูลของท่านจะได้รับการดูแลอย่างปลอดภัยและถูกต้องตามกฎหมาย PDPA ทุกประการ`
)
